...
HIGH = 1
LOW = 0
email_from = " pellecchia#@nex2.it"


def set_yaml_config(config_file='/home/nex2/Scrivania/MOXA-ioLogik-E1210-master/monitor.py'):
    cfg = ''
    try:
...
def run(yaml):
    while True:
        error = False
        try:
            reply = requests.get("http://192.168.1.11/api/slot/0/io/di",
